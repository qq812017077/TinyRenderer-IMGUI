...
//     return true;
// }
// bool ShaderBase::SetTexture(const char * name, std::shared_ptr<Texture> pTex, std::string& samplerName)
// {
//     auto pTexVar = GetTextureByName(name);
//     if(pTexVar == nullptr) return false;
//     pTexVar->Set(name, pTex, samplerName);
//     return true;
// }
